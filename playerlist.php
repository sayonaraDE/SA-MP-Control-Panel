        ...
        <div class="container">
            ...
            <nav class="navigation clearfix">
                <ul class="sf-menu nav">
					...
					<li class="active"><a href="playerlist.php">Online Players</a></li>
                </ul>
            </nav>
            <!-- /Navigation -->
            ...
            <div class="container div-table">
                ...
                <div class="parallax-inner text-center">
					<table class="table table-bordered">
						...
						<?php
							echo "<tr><td>".print_r($monitor->get_ad_by_id(53484));"</td>";
							 echo "<td>".print_r($monitor->get_players_by_id(53484));"</td>";
							//echo "<td>".print_r($monitor->get_query_by_id(53484));"</td>";
							// echo "<td>".print_r($monitor->get_info_by_id(53484));"</td></tr>";
