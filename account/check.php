<?php
	...
	if(isset($_POST['username'], $_POST['password'], $_POST['password2'], $_POST['o_password']))
	{
		if($_POST['username'] !== '' && $_POST['password'] !== '' && $_POST['password2'] !== '' && $_POST['o_password'] !== '')
		{
			...
			$query->execute(array($_POST['username'], sha1($_POST['o_password'])));
			if($query->rowCount() > 0)
			{
				...
				else
				{
					...
					$query->execute(array(strtoupper(hash("whirlpool", $_POST['password'])), $_POST['username'], sha1($_POST['o_password'])));
